/*
VERSION 1.0.8 (Couple of other fixes);
*/
/*GLOBAL VARIABLES*/
let alertArray = [];
/*Init function*/
...
function firstQA() {
    ...
    //Additional
    const array_of_items = ["<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Read brief in SPARC <br>", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Auto filter recipients<br> (if Admin, to be unticked)", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Review import file and its columns", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> From And Reply Address <br>", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Subject line & Preheader", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Footer (if admin campaign = admin footer)", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Images Are Published", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Layout Desktop (Mobile)<br>(if multiple conditional content, with ignore conditions)", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Personalized fields populated with real data<br>", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Links: for T&C, Main CTA <br>", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Conditional split % <br>and condition sense check"];
...
function checkAllTheLinks() {
    ...
    for (var i = 0; i < all_links.length; i++) {
        ...
        //d
        if (((arr_links.toString()).endsWith(".com")) || (arr_links.toString().endsWith('/')) || (arr_links.toString().endsWith('.html')) || (arr_links.toString().endsWith('.com.au')) || (arr_links.toString().endsWith('.be')) || (arr_links.toString().endsWith('.ca')) || (arr_links.toString().endsWith('.fr')) || (arr_links.toString().endsWith('.com.hk')) || (arr_links.toString().endsWith('.in')) || (arr_links.toString().endsWith('.com.m')) || (arr_links.toString().endsWith('.nl')) || (arr_links.toString().endsWith('.ph')) || (arr_links.toString().endsWith('.pl')) || (arr_links.toString().endsWith('.com.sg')) || (arr_links.toString().endsWith('.es')) || (arr_links.toString().endsWith('.vn')) || (arr_links.toString().endsWith('.co.uk')) || (arr_links.toString().endsWith('.com')) || (arr_links.toString().endsWith('.com.tw')) || (arr_links.toString().endsWith('.com.sea')) || (arr_links.toString().endsWith('.it')) || (arr_links.toString().endsWith('.co.jp')) || (arr_links.toString().endsWith('.co.th')) || (arr_links.toString().endsWith('.co.id')) || (arr_links.toString().endsWith('.cn')) || (arr_links.toString().endsWith('.de')) || (arr_links.toString().endsWith('.co.il')) || (arr_links.toString().endsWith('.hk')) || (arr_links.toString().endsWith('.ch')) || (arr_links.toString().endsWith('.at')) || (arr_links.toString().endsWith('.ie'))) {

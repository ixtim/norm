...
function firstQA() {
  ...
  //Additional
  const array_of_items = ["<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Read brief in SPARC <br>","<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Auto filter recipients<br> (if Admin, to be unticked)","<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Review import file and its columns","<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> From And Reply Address <br>","<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Subject line & Preheader","<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Footer (if admin campaign = admin footer)","<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Images Published?","<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Layout Desktop (Mobile)<br>(ignore  multiple conditions)","<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Personalized fields populated with real data<br>","<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Links: for T&C, Main CTA <br>","<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Conditional split % <br>and condition sense check"];
...
const buttonForMC = "#copy_button{display:block;margin: 0 auto;margin-top: 5px;background: white;padding: 4px;border-radius: 6px;color: #545454 !important;font-weight: bold; border: 2px solid #0bb1f1;}"
 style_app.innerHTML = buttonForMC+modalAlertBox+alertBox+appearBox+log_messages+custom_aybe_scrollbar+ wiki_styles+jump_window+sparc_number+ul_li+dialog_window+open_close+select_styles + ".ahojky{box-sizing: content-box;overflow-y: scroll;overflow-x: hidden;max-height:650px ;padding:20px;position:fixed;top:0px;right:0px;width:200px;height:auto;border:3px solid rgba(255,255,255,0.1);background-color:rgba(197, 211, 246, 1);z-index:9999}.ahojky:hover{background-color:rgba(255,255,255,0.8);}" + option_styles;
